                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-col items-center lg:hidden">
                      ...
                      <div className="relative z-10 w-12 h-12 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center border-4 border-white dark:border-gray-900 hover-lift hover-magnetic transition-all duration-500 mb-4">
                      ...
                      <div className="w-full max-w-sm">
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-primary/50 dark:hover:border-primary/50 transition-all duration-500 hover-lift hover-tilt click-effect shadow-sm dark:shadow-lg">
                          ...
                          <h4 className="text-xl font-bold text-gray-800 dark:text-gray-100 mb-2 text-center transition-colors duration-500">{item.title}</h4>
                          <p className="text-gray-600 dark:text-gray-400 mb-3 text-center transition-colors duration-500">{item.description}</p>
